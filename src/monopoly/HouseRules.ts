...
export interface HouseRules {
    ...
    /** When a player rolls doubles to get out of jail, whether they are awarded a second turn. */
    ...
    /** When a player goes bankrupt to an opponent, whether their assests are given to the bank instead of the opponent. */
    ...
    /** How many turns a player is allowed to stay in jail for before being forced to post bail. */
    turnsInJail: number;
    /** The amount of money a player needs to spend to pay to get out of jail. */
    bailAmount: number;

    /** The number of consecutive doubles a player is allowed to roll before being sent to jail. */
